 ...
 */
		...
		ALIGN64 pSendChannelPacketEx SendChannelPacketEx; /* (offset 73) remove as unused ???? */
		ALIGN64 pUdpChannelEstablished UdpChannelEstablished; /* (offset 74) Callback when a UDP channel is established */
		UINT64 paddingE[80 - 75];                         /* 75 */
	};
