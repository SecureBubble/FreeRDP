...
static const struct settings_str_entry settings_map[] =
{
		...
		{FreeRDP_AllowDesktopComposition, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_AllowDesktopComposition"},
		{FreeRDP_AllowFontSmoothing, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_AllowFontSmoothing"},
		{FreeRDP_AllowUnanouncedOrdersFromServer, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_AllowUnanouncedOrdersFromServer"},
		{FreeRDP_AltSecFrameMarkerSupport, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_AltSecFrameMarkerSupport"},
		...
		{FreeRDP_AutoReconnectionEnabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_AutoReconnectionEnabled"},
		{FreeRDP_AutoReconnectionPacketSupported, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_AutoReconnectionPacketSupported"},
		{FreeRDP_BitmapCacheEnabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_BitmapCacheEnabled"},
		{FreeRDP_BitmapCachePersistEnabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_BitmapCachePersistEnabled"},
		{FreeRDP_BitmapCacheV3Enabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_BitmapCacheV3Enabled"},
		{FreeRDP_BitmapCompressionDisabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_BitmapCompressionDisabled"},
		{FreeRDP_CertificateCallbackPreferPEM, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_CertificateCallbackPreferPEM"},
		...
		{FreeRDP_DeactivateClientDecoding, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DeactivateClientDecoding"},
		...
		{FreeRDP_DisableCredentialsDelegation, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DisableCredentialsDelegation"},
		...
		{FreeRDP_DisableRemoteAppCapsCheck, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DisableRemoteAppCapsCheck"},
		...
		{FreeRDP_DrawAllowColorSubsampling, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DrawAllowColorSubsampling"},
		{FreeRDP_DrawAllowDynamicColorFidelity, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DrawAllowDynamicColorFidelity"},
		{FreeRDP_DrawAllowSkipAlpha, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DrawAllowSkipAlpha"},
		{FreeRDP_DrawGdiPlusCacheEnabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DrawGdiPlusCacheEnabled"},
		...
		{FreeRDP_DynamicDaylightTimeDisabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DynamicDaylightTimeDisabled"},
		{FreeRDP_DynamicResolutionUpdate, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_DynamicResolutionUpdate"},
		...
		{FreeRDP_ExternalCertificateManagement, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_ExternalCertificateManagement"},
		...
		{FreeRDP_FrameMarkerCommandEnabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_FrameMarkerCommandEnabled"},
		...
		{FreeRDP_GatewayHttpExtAuthSspiNtlm, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_GatewayHttpExtAuthSspiNtlm"},
		{FreeRDP_GatewayHttpTransport, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_GatewayHttpTransport"},
		{FreeRDP_GatewayHttpUseWebsockets, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_GatewayHttpUseWebsockets"},
		{FreeRDP_GatewayIgnoreRedirectionPolicy, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_GatewayIgnoreRedirectionPolicy"},
		...
		{FreeRDP_GatewayUseSameCredentials, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_GatewayUseSameCredentials"},
		...
		{FreeRDP_LongCredentialsSupported, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_LongCredentialsSupported"},
		...
		{FreeRDP_NSCodecAllowDynamicColorFidelity, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_NSCodecAllowDynamicColorFidelity"},
		{FreeRDP_NSCodecAllowSubsampling, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_NSCodecAllowSubsampling"},
		...
		{FreeRDP_NoBitmapCompressionHeader, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_NoBitmapCompressionHeader"},
		{FreeRDP_OldLicenseBehaviour, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_OldLicenseBehaviour"},
		{FreeRDP_PasswordIsSmartcardPin, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_PasswordIsSmartcardPin"},
		{FreeRDP_PercentScreenUseHeight, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_PercentScreenUseHeight"},
		...
		{FreeRDP_RemoteAssistanceRequestControl, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_RemoteAssistanceRequestControl"},
		...
		{FreeRDP_RestrictedAdminModeRequired, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_RestrictedAdminModeRequired"},
		{FreeRDP_RestrictedAdminModeSupported, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_RestrictedAdminModeSupported"},
		...
		{FreeRDP_SupportDynamicChannels, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportDynamicChannels"},
		{FreeRDP_SupportDynamicTimeZone, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportDynamicTimeZone"},
		...
		{FreeRDP_SupportGeometryTracking, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportGeometryTracking"},
		{FreeRDP_SupportGraphicsPipeline, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportGraphicsPipeline"},
		{FreeRDP_SupportHeartbeatPdu, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportHeartbeatPdu"},
		{FreeRDP_SupportMonitorLayoutPdu, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportMonitorLayoutPdu"},
		{FreeRDP_SupportMultitransport, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportMultitransport"},
		{FreeRDP_SupportSSHAgentChannel, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportSSHAgentChannel"},
		{FreeRDP_SupportSkipChannelJoin, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SupportSkipChannelJoin"},
		...
		{FreeRDP_SurfaceCommandsEnabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SurfaceCommandsEnabled"},
		{FreeRDP_SurfaceFrameMarkerEnabled, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_SurfaceFrameMarkerEnabled"},
		...
		{FreeRDP_TransportDumpReplayNodelay, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_TransportDumpReplayNodelay"},
		...
		{FreeRDP_UseCommonStdioCallbacks, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_UseCommonStdioCallbacks"},
		...
		{FreeRDP_WaitForOutputBufferFlush, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_WaitForOutputBufferFlush"},
		{FreeRDP_Workarea, FREERDP_SETTINGS_TYPE_BOOL, "FreeRDP_Workarea"},
		{FreeRDP_CapsGeneralCompressionLevel, FREERDP_SETTINGS_TYPE_UINT16, "FreeRDP_CapsGeneralCompressionLevel"},
		{FreeRDP_CapsGeneralCompressionTypes, FREERDP_SETTINGS_TYPE_UINT16, "FreeRDP_CapsGeneralCompressionTypes"},
		{FreeRDP_CapsProtocolVersion, FREERDP_SETTINGS_TYPE_UINT16, "FreeRDP_CapsProtocolVersion"},
		{FreeRDP_CapsRemoteUnshareFlag, FREERDP_SETTINGS_TYPE_UINT16, "FreeRDP_CapsRemoteUnshareFlag"},
		{FreeRDP_CapsUpdateCapabilityFlag, FREERDP_SETTINGS_TYPE_UINT16, "FreeRDP_CapsUpdateCapabilityFlag"},
		...
		{FreeRDP_AutoReconnectMaxRetries, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_AutoReconnectMaxRetries"},
		{FreeRDP_BitmapCacheV2NumCells, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_BitmapCacheV2NumCells"},
		...
		{FreeRDP_ColorPointerCacheSize, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_ColorPointerCacheSize"},
		...
		{FreeRDP_DesktopPhysicalHeight, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_DesktopPhysicalHeight"},
		...
		{FreeRDP_DrawNineGridCacheEntries, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_DrawNineGridCacheEntries"},
		{FreeRDP_DrawNineGridCacheSize, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_DrawNineGridCacheSize"},
		{FreeRDP_DynamicChannelArraySize, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_DynamicChannelArraySize"},
		...
		{FreeRDP_FakeMouseMotionInterval, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_FakeMouseMotionInterval"},
		...
		{FreeRDP_GatewayAcceptedCertLength, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_GatewayAcceptedCertLength"},
		{FreeRDP_GatewayCredentialsSource, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_GatewayCredentialsSource"},
		...
		{FreeRDP_LoadBalanceInfoLength, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_LoadBalanceInfoLength"},
		{FreeRDP_MaxPendingUdpPackets, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_MaxPendingUdpPackets"},
		{FreeRDP_MonitorAttributeFlags, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_MonitorAttributeFlags"},
		...
		{FreeRDP_MultifragMaxRequestSize, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_MultifragMaxRequestSize"},
		...
		{FreeRDP_OffscreenCacheEntries, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_OffscreenCacheEntries"},
		{FreeRDP_OffscreenCacheSize, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_OffscreenCacheSize"},
		{FreeRDP_OffscreenSupportLevel, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_OffscreenSupportLevel"},
		...
		{FreeRDP_RedirectionAcceptedCertLength, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RedirectionAcceptedCertLength"},
		{FreeRDP_RedirectionFlags, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RedirectionFlags"},
		{FreeRDP_RedirectionGuidLength, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RedirectionGuidLength"},
		{FreeRDP_RedirectionPasswordLength, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RedirectionPasswordLength"},
		{FreeRDP_RedirectionPreferType, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RedirectionPreferType"},
		{FreeRDP_RedirectionTsvUrlLength, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RedirectionTsvUrlLength"},
		{FreeRDP_RemoteAppNumIconCacheEntries, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteAppNumIconCacheEntries"},
		{FreeRDP_RemoteAppNumIconCaches, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteAppNumIconCaches"},
		{FreeRDP_RemoteApplicationExpandCmdLine, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteApplicationExpandCmdLine"},
		{FreeRDP_RemoteApplicationExpandWorkingDir, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteApplicationExpandWorkingDir"},
		{FreeRDP_RemoteApplicationSupportLevel, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteApplicationSupportLevel"},
		{FreeRDP_RemoteApplicationSupportMask, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteApplicationSupportMask"},
		...
		{FreeRDP_RemoteMultitransportFlags, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteMultitransportFlags"},
		{FreeRDP_RemoteWndSupportLevel, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_RemoteWndSupportLevel"},
		...
		{FreeRDP_ServerCertificateLength, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_ServerCertificateLength"},
		{FreeRDP_ServerLicenseProductIssuersCount, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_ServerLicenseProductIssuersCount"},
		{FreeRDP_ServerLicenseProductVersion, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_ServerLicenseProductVersion"},
		...
		{FreeRDP_StaticChannelArraySize, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_StaticChannelArraySize"},
		{FreeRDP_StaticChannelCount, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_StaticChannelCount"},
		{FreeRDP_SurfaceCommandsSupported, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_SurfaceCommandsSupported"},
		{FreeRDP_TargetNetAddressCount, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_TargetNetAddressCount"},
		...
		{FreeRDP_AuthenticationPackageList, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_AuthenticationPackageList"},
		{FreeRDP_AuthenticationServiceClass, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_AuthenticationServiceClass"},
		{FreeRDP_BitmapCachePersistFile, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_BitmapCachePersistFile"},
		{FreeRDP_CardName, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_CardName"},
		{FreeRDP_CertificateAcceptedFingerprints, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_CertificateAcceptedFingerprints"},
		...
		{FreeRDP_DynamicDSTTimeZoneKeyName, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_DynamicDSTTimeZoneKeyName"},
		...
		{FreeRDP_GatewayAvdAadtenantid, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdAadtenantid"},
		{FreeRDP_GatewayAvdAccessAadFormat, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdAccessAadFormat"},
		{FreeRDP_GatewayAvdAccessTokenFormat, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdAccessTokenFormat"},
		{FreeRDP_GatewayAvdActivityhint, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdActivityhint"},
		...
		{FreeRDP_GatewayAvdDiagnosticserviceurl, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdDiagnosticserviceurl"},
		{FreeRDP_GatewayAvdGeo, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdGeo"},
		{FreeRDP_GatewayAvdHubdiscoverygeourl, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdHubdiscoverygeourl"},
		{FreeRDP_GatewayAvdScope, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdScope"},
		{FreeRDP_GatewayAvdWvdEndpointPool, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAvdWvdEndpointPool"},
		{FreeRDP_GatewayAzureActiveDirectory, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayAzureActiveDirectory"},
		...
		{FreeRDP_GatewayHttpExtAuthBearer, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayHttpExtAuthBearer"},
		{FreeRDP_GatewayHttpMsUserAgent, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_GatewayHttpMsUserAgent"},
		...
		{FreeRDP_KerberosRenewableLifeTime, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_KerberosRenewableLifeTime"},
		...
		{FreeRDP_KeyboardRemappingList, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_KeyboardRemappingList"},
		...
		{FreeRDP_RedirectionAcceptedCert, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RedirectionAcceptedCert"},
		{FreeRDP_RedirectionDomain, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RedirectionDomain"},
		{FreeRDP_RedirectionTargetFQDN, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RedirectionTargetFQDN"},
		{FreeRDP_RedirectionTargetNetBiosName, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RedirectionTargetNetBiosName"},
		{FreeRDP_RedirectionUsername, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RedirectionUsername"},
		{FreeRDP_RemoteApplicationCmdLine, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteApplicationCmdLine"},
		{FreeRDP_RemoteApplicationFile, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteApplicationFile"},
		{FreeRDP_RemoteApplicationGuid, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteApplicationGuid"},
		{FreeRDP_RemoteApplicationIcon, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteApplicationIcon"},
		{FreeRDP_RemoteApplicationName, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteApplicationName"},
		{FreeRDP_RemoteApplicationProgram, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteApplicationProgram"},
		{FreeRDP_RemoteApplicationWorkingDir, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteApplicationWorkingDir"},
		{FreeRDP_RemoteAssistancePassStub, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteAssistancePassStub"},
		{FreeRDP_RemoteAssistancePassword, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteAssistancePassword"},
		{FreeRDP_RemoteAssistanceRCTicket, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteAssistanceRCTicket"},
		{FreeRDP_RemoteAssistanceSessionId, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_RemoteAssistanceSessionId"},
		{FreeRDP_ServerHostname, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_ServerHostname"},
		{FreeRDP_ServerLicenseCompanyName, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_ServerLicenseCompanyName"},
		{FreeRDP_ServerLicenseProductName, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_ServerLicenseProductName"},
		{FreeRDP_ShellWorkingDirectory, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_ShellWorkingDirectory"},
		...
		{FreeRDP_UserSpecifiedServerName, FREERDP_SETTINGS_TYPE_STRING, "FreeRDP_UserSpecifiedServerName"},
		...
		{FreeRDP_BitmapCacheV2CellInfo, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_BitmapCacheV2CellInfo"},
		{FreeRDP_ChannelDefArray, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_ChannelDefArray"},
		{FreeRDP_ClientAutoReconnectCookie, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_ClientAutoReconnectCookie"},
		...
		{FreeRDP_ReceivedCapabilityData, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_ReceivedCapabilityData"},
		{FreeRDP_ReceivedCapabilityDataSizes, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_ReceivedCapabilityDataSizes"},
		...
		{FreeRDP_RedirectionTargetCertificate, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_RedirectionTargetCertificate"},
		{FreeRDP_RedirectionTsvUrl, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_RedirectionTsvUrl"},
		{FreeRDP_ServerAutoReconnectCookie, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_ServerAutoReconnectCookie"},
		{FreeRDP_ServerCertificate, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_ServerCertificate"},
		{FreeRDP_ServerLicenseProductIssuers, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_ServerLicenseProductIssuers"},
